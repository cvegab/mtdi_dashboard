...
const MtdiTable = (props) => {
  ...
  const fetchOrderData = async () => {
    ...
    let rolesUrl='';
    if(localStorage.getItem("ut")==='1'){
       rolesUrl = `https://32q0xdsl4b.execute-api.sa-east-1.amazonaws.com/preproduction/store/orders?qty=100&user=admin&channel=${channelId}&store=${storeId}&page=1&country=${countryId}&dateFrom=${selectedDateFrom}&dateTo=${selectedDateTo}`
    }
    if(localStorage.getItem("ut")==='2'){
