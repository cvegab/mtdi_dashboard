...
return(
    ...
    <figure>
        ...
        <figcaption style={{color:'black'}}>Hoy a las 12:40pm</figcaption>
    </figure>
    <figure>
        <img src={dispatchStep1} style={{ float: "left", marginRight: "40px" }}/>
        <figcaption style={{color:'#D8D8D8;'}}>Hoy a las 12:40pm</figcaption>
    </figure>
    <figure>
...
{/* <div class="container">
    <figure>
        <img src={step2Prep} style={{ float: "left", marginRight: "40px" }}/>
        <figcaption style={{color:'black'}}>Hoy a las 12:40pm</figcaption>
    </figure>
    <figure>
        <img src={step2readytodispatch} style={{ float: "left", marginRight: "40px" }}/>
        <figcaption style={{color:'#D8D8D8;'}}>Hoy a las 12:40pm</figcaption>
    </figure>
    <figure>
        <img src={inDispatchStep1} style={{ float: "left", marginRight: "40px" }}/>
...
{/* <div class="container">
    ...
    <figure>
        <img src={step3ReadyToDispatch} style={{ float: "left", marginRight: "40px" }}/>
        <figcaption style={{color:'black'}}>Hoy a las 12:40pm</figcaption>
    </figure>
    <figure>
        <img src={step3inDispatch} style={{ float: "left", marginRight: "40px" }}/>
        <figcaption style={{color:'black'}}>Mañana a la 1:30 p.m</figcaption>
    </figure>
    <figure>
        <img src={arrivalStep1} style={{ float: "left", marginRight: "40px" }}/>
        <figcaption>Mañana a la 1:30 p.m</figcaption>
...
{/* <div class="container">
    ...
    <figure>
        <img src={step4InDispatch} style={{ float: "left", marginRight: "40px" }}/>
        <figcaption style={{color:'black'}}>Mañana a la 1:30 p.m</figcaption>
    </figure>
    <figure>
        <img src={step4ArrivalReady} style={{ float: "left", marginRight: "40px" }}/>
        <figcaption style={{color:'black'}}>Mañana a la 1:30 p.m</figcaption>
    </figure>
    <figure>
        <img src={clientstep1} style={{ float: "left", marginRight: "40px" }}/>
...
<div class="container">
    <figure>
        <img src={step2Prep} style={{ float: "left", marginRight: "43px" }}/>
        <figcaption style={{color:'black'}}>Hoy a las 12:40pm</figcaption>
    </figure>
    <figure>
        <img src={step3ReadyToDispatch} style={{ float: "left", marginRight: "43px" }}/>
        <figcaption style={{color:'black'}}>Hoy a las 12:40pm</figcaption>
    </figure>
    <figure>
        <img src={step4InDispatch} style={{ float: "left", marginRight: "43px" }}/>
        <figcaption style={{color:'black'}}>Mañana a la 1:30 p.m</figcaption>
    </figure>
    <figure>
        <img src={step5ArrivalReady} style={{ float: "left", marginRight: "43px" }}/>
        <figcaption style={{color:'black'}}>Mañana a la 1:30 p.m</figcaption>
    </figure>
    <figure>
        <img src={step5Recieved} style={{ float: "left", marginRight: "43px" }}/>
        <figcaption style={{color:'black'}}>Mañana a la 1:30 p.m</figcaption>
    </figure>
</div>
