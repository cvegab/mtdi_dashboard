...
const StackedOrderGraph = (props) => {
  ...
  useEffect(() => {
    ...
    props.newlinioMonthly,
    props.newVtexMonthly,
    props.newRipleyMonthly,
    props.newChambasMonthly,
    props.newMagentoMonthly,
    props.newWooCommerceMonthly,
    props.newShopifyMonthly,
    props.newMercadoOrdersMonthly,
    props.newParisOrders,
    props.newExtitoOrders,
    props.newListaOrders,
  ]);
    ...
    let MONTLY_ORDER_GRAPH = {
      ...
      datasets: [
        ...
        },
        {
          ...
          stack: "2",
          borderRadius: 6,
          data: props.newMercadoOrdersMonthly,
          barThickness: 30,
        },
        {
          label: "Paris",
        ...
        },
        {
          ...
          barThickness: 30,
          stack: "2",
          data: props.newWooCommerceMonthly,
        },
      ],
      options: {
        plugins: {
  ...
  return (
    <React.Fragment>
      {props.isStackedOrdersGraph && <SplashScreen message="Reportes"></SplashScreen>}
