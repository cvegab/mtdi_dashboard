        ...
        <table width="100%">
          ...
          <tr>
            <td style="background-color:  #F3F6F9; color:#1D308E; border-radius: 17px; width: 20px; height:20px;">
              ...
              <p  id="textWarning" style="text-align: left; font-weight: 700; line-height: 17px; font-size: 12px; margin-left:3em;"> Este correo cumple solo un carácter informativo. Tu documentación tributaria oficial será entregada junto con tu pedido.</p>
            </td>
          </tr>
        </table>
      </td>
